  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Aqui está um resumo da sua atividade como Transportador.</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card className="flex flex-col">
          <CardHeader>
            <CardTitle>Encontre seu próximo frete</CardTitle>
            <CardDescription>Milhares de cargas esperando por você em todo o Brasil.</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <Button asChild>
              <Link href="/dashboard/company/freights">
                Ver Fretes
        ...
        <Card className="flex flex-col">
          ...
          <CardContent>
            <Button asChild>
              <Link href="/dashboard/company/cost-calculator">
                Fazer Cálculo
                <ArrowRight className="ml-2 h-4 w-4" />
              </Link>
            </Button>
