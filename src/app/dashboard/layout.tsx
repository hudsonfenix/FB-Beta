...
const navItems = [
  { href: "/dashboard", icon: LayoutGrid, label: "Painel" },
  { href: "/dashboard/post-freight", icon: PlusCircle, label: "Cadastrar Fretes" },
  { href: "/dashboard/my-freights", icon: Package, label: "Meus Fretes" },
  { href: "/dashboard/freights", icon: Truck, label: "Ver todos os fretes" },
];
